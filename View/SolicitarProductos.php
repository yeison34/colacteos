            ...
            <div id="modal" class="modal-comprar-producto">
                ...
                <form action="ProductosConfirmados.php" method="POST">
                    <ul class="form-solicitud">
                        ...
                        <li>Cantidad: <input type="text" name="cantidad"></li>
                    </ul> 
                        ...
                        while($cont!=count($resultado)){
                            ...
                            <div class="fila">
                                <ul class="marco">
                                        ...
                                        <li><a href="#?id_producto=<?php echo $resultado[$cont]['cod_producto']?>&id_proveedor=<?php echo $resultado[$cont]['nit_empresa']?>&nombre=<?php echo $resultado[$cont]['nombre_producto']?>&descripcion=<?php echo $resultado[$cont]['descripcion']?>&precio=<?php echo $resultado[$cont]['precio_unit']?>" id="compra<?php echo $cont?>"><button>Comprar</button></a></li>
                                </ul>
                            </div>    
                            <?php
                            $cont++;

...
<body>
	...
	<?php
		...
		if(isset($_SESSION['proveedor'])){
			...
			$datos=$proveedor->getCompleteInformation($_SESSION['proveedor']);
			$paises=new Pais();
	...
	<section class="editarPerfil">
		<div class="user-online-update">
			<h1><?php echo strtoupper($datos['nom_empresa']);?></h1>
		</div>
		<h2>Datos Generales</h2>
		<div class="general">
			<form method="post" action="ActualizarPerfilProveedor.php" enctype="multipart/form-data">
				<ul>
					<li>Nit-Empresa: <input type="text" name="" value="<?php echo strtoupper($datos['nit_empresa']);?>" disabled></li>
					<li>Nombre-Empresa: <input type="text" name="" value="<?php echo strtoupper($datos['nom_empresa'])?>" disabled></li>
					<li>Direccion: <input type="text" name="direccion" value="<?php echo strtoupper($datos['direccion']);?>"></li>
					<li>Estado: 
						<select name="estado">
								<option>Selected</option>								
								<option selected value="<?php echo $estado1?>"><?php echo $estado1?></option>
